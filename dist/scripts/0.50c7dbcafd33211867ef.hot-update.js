	...
	var mainModule = function () {
	  ...
	  */
		...
		var roadMap = function roadMap() {
			...
			(0, _jquery2.default)('#roadmap').on('beforeChange', function (event, slick, direction) {
				(0, _jquery2.default)('.slick-active .road-map-slider__line').removeClass('road-map-slider__line--last');
			});
			(0, _jquery2.default)('#roadmap').on('afterChange', function (event, slick, direction) {
				(0, _jquery2.default)('.slick-active:eq(3) .road-map-slider__line').addClass('road-map-slider__line--last');
			});
		};
		...
		var scroll = function scroll() {
			(0, _jquery2.default)('.leadership__text-wrapper, .advisors__text-wrapper').jScrollPane({
		...
		var burgerMenu = function burgerMenu() {
			...
			(0, _jquery2.default)('.burger-click-region').on('click', function () {
				...
				if ((0, _jquery2.default)('.burger-click-region').hasClass('active')) {
					(0, _jquery2.default)('.navigation__nav-list').addClass('navigation__nav-list--open');
					(0, _jquery2.default)('body').addClass('menu-open');
				} else {
					(0, _jquery2.default)('.navigation__nav-list').removeClass('navigation__nav-list--open');
		...
		var leadershipSlider = function leadershipSlider() {
			function slickify() {
				(0, _jquery2.default)('#leadership').not('.slick-initialized').slick({
					dots: true,
					slidesToShow: 1.6,
					slidesToScroll: 1,
					infinite: false,
		...
		var othermemberSlider = function othermemberSlider() {
			function slickify() {
				(0, _jquery2.default)('#other-member').not('.slick-initialized').slick({
					dots: true,
					slidesToShow: 3,
					slidesToScroll: 3,
					infinite: false,
		...
		var advisorsSlider = function advisorsSlider() {
			function slickify() {
				(0, _jquery2.default)('#advisors').not('.slick-initialized').slick({
					dots: true,
					slidesToShow: 1.6,
					slidesToScroll: 1,
					infinite: false,
		...
		var langButton = function langButton() {
			(0, _jquery2.default)('.navigation__language-active').on('click', function () {
		...
		var wayPoint = function wayPoint() {
			(0, _jquery2.default)('section').waypoint({
				handler: function handler(direction) {
					...
					(0, _jquery2.default)('.navigation__nav-item').removeClass('navigation__nav-item--active');
...
//# sourceMappingURL=0.50c7dbcafd33211867ef.hot-update.js.map