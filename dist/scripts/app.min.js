...
/******/ 	var hotCurrentHash = "e9bcf1d7ae355a6afd7a"; // eslint-disable-line no-unused-vars
	  ...
	  */
		...
		var roadMap = function roadMap() {
			...
			(0, _jquery2.default)(elements.roadMapSlider).on('afterChange', function (event, slick, direction) {
				(0, _jquery2.default)('.slick-active .road-map-slider__line:eq(3)').addClass('road-map-slider__line--last');
			});
		};
		...
		var formSubscribe = function formSubscribe() {
			ajaxMailChimpForm((0, _jquery2.default)("#modal-form"), (0, _jquery2.default)(".modal-subscribe-result"));
			ajaxMailChimpForm((0, _jquery2.default)("#subscribe-form"), (0, _jquery2.default)(".window-subscribe-result"));
