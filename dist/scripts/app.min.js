...
/******/ 	var hotCurrentHash = "50c7dbcafd33211867ef"; // eslint-disable-line no-unused-vars
		...
		var stickyMenu = function stickyMenu() {
			(0, _jquery2.default)(window).bind('scroll', function () {
				if ((0, _jquery2.default)(window).scrollTop() > 50) {
					(0, _jquery2.default)('.navigation').addClass('fixed');
				} else {
					(0, _jquery2.default)('.navigation').removeClass('fixed');
				}
			});
		};
