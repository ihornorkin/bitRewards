		...
		var date = function date() {
			...
			(0, _jquery2.default)('#roadmap .road-map-slider__item').each(function (slide, index) {
				...
				if ((0, _jquery2.default)(this).hasClass('road-map-slider__item--present')) {
					(0, _jquery2.default)(this).find('.road-map-slider__stage').appendTo('<span class="road-map-slider__status"> - Completed</span>');
				}
			});
			//$('.road-map-slider__item--present')
		};
...
//# sourceMappingURL=0.61927bd124d79a548af3.hot-update.js.map