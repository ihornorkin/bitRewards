	...
	var mainModule = function () {
	  ...
	  */
		...
		var formSubscribe = function formSubscribe() {
			ajaxMailChimpForm((0, _jquery2.default)(".form"), (0, _jquery2.default)(".subscribe-result"));
			...
			function ajaxMailChimpForm($form, $resultElement) {
				...
				$form.submit(function (e) {
					...
					if (!isValidEmail($form)) {
						...
						$form.find('.subscribe-result').html(error);
						$form.find('.subscribe-result')("color", "red");
					} else {
						$form.find('.subscribe-result').html("Subscribing...");
				...
				_jquery2.default.ajax({
					...
					success: function success(data) {
						...
						if (data.result != "success") {
							...
							$form.find('.subscribe-result').html(message);
						} else {
							$form.find('.subscribe-result').html("Thank you!<br>You must confirm the subscription in your inbox.");
						}
					}
				});
			}
...
//# sourceMappingURL=0.f5eccc7ba1901ac981c8.hot-update.js.map