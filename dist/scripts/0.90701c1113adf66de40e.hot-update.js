...
/***/ (function(module, exports, __webpack_require__) {
	...
	var mainModule = function () {
		...
		var cacheDOM = function cacheDOM() {
			...
			self.navigation = (0, _jquery2.default)('.navigation__nav-list');
	  ...
	  */
		...
		var burgerMenu = function burgerMenu() {
			...
			(0, _jquery2.default)(elements.burger).on('click', function () {
				...
				if ((0, _jquery2.default)(elements.burger).hasClass('active')) {
					(0, _jquery2.default)(elements.navigation).addClass('navigation__nav-list--open');
					(0, _jquery2.default)('body').addClass('menu-open');
				} else {
					(0, _jquery2.default)(elements.navigation).removeClass('navigation__nav-list--open');
		...
		var advisorsSlider = function advisorsSlider() {
			function slickify() {
				(0, _jquery2.default)('#advisors-sldier').not('.slick-initialized').slick({
					dots: true,
					slidesToShow: 1.6,
					slidesToScroll: 1,
					infinite: false,
...
//# sourceMappingURL=0.90701c1113adf66de40e.hot-update.js.map